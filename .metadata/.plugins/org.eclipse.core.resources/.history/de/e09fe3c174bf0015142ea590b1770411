...
/*
 * 以下是按照50HZ的刷新频率采集数据、计算角度
 * 陀螺仪采样频率：50HZ
 */
/*
 * ===================================================================
 *     Method      : Read_Pro_Data(Module Process)
 */
/*!
 *     @brief
 *          This method reads sensor's data when sensor's is ready to be read.
...
void Read_Pro_Data(void)
{
    ...
    if(tSENSORPtr->sensorStatus.isDataReady == 1)
    {
    	//if this is first init sensor data
    	if(first_data)
    	{
    		init_quaternion();
    		first_data = 0;
