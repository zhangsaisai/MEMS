#ifndef _NRF24L01_2_H_
#define _NRF24L01_2_H_
#include "stm32f10x.h"
//***************************************NRF24L01寄存器指令*******************************************************
...
void Nrf24l01_2_Init(u8 model, u8 ch);				//初始化,model=1/2/3/4,ch为实用的通道号
void NRF2_TxPacket(uint8_t * tx_buf, uint8_t len);			//发送数据包,用于model 2/4
void NRF2_TxPacket_AP(uint8_t * tx_buf, uint8_t len);	//发送数据包,用于model 3
