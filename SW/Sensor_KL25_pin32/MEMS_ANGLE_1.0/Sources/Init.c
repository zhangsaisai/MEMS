...
void ARMDataInit(TARMDataPtr userDataPtr)
{
    ...
    tARM.armDataLeft.dataFrame[1] = 0x00U;                                      /* Data length high bits;96 bytes */
    tARM.armDataLeft.dataFrame[2] = 0x60U;                                      /* Data length low bits;96 bytes */
    tARM.armDataLeft.dataFrame[3] = 0x01U & eLeftBuffer;                        /* Status high bits */
    tARM.armDataLeft.dataFrame[4] = 0x00U;                                      /* Status low bits */
    ...
    tARM.armDataRight.dataFrame[1] = 0x00U;                                      /* Data length high bits */
    tARM.armDataRight.dataFrame[2] = 0x60U;                                      /* Data length low bits */
    tARM.armDataRight.dataFrame[3] = 0x01U & eRightBuffer;                       /* Status high bits */
    tARM.armDataRight.dataFrame[4] = 0x00U;                                      /* Status low bits */
...
void GPIOInit(void)
{
     ...
     */
	 MPU6050_DRDY_Init(NULL);
	  /*
	   * Initialize PortA4 , the led indicates the calibration of mag
	   */
	 Led_Init(NULL);
...
void SPIInit(void)
{
    ...
    SPI0 = SPI0Init(NULL);      /* Initialize SPI0 in slave mode. */
